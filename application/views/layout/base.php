...
<html lang="pt-br" class="h-100">
  <head>
    ...
    <link rel="stylesheet" href="{{ constant('BASE_URL') }}assets/tempusdominus/css/tempusdominus-bootstrap-4.min.css">
    <link rel="stylesheet" href="{{ constant('BASE_URL') }}assets/izitoast/css/iziToast.min.css">
  ...
  <body class="d-flex flex-column h-100">
    ...
    {% block scripts %}
      ...
      <script src="{{ constant('BASE_URL') }}assets/table-export/tableExport.min.js"></script>
      <script src="{{ constant('BASE_URL') }}assets/bootstrap-table/extensions/export/bootstrap-table-export.min.js"></script>
      ...
      <script src="{{ constant('BASE_URL') }}assets/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
      <script src="{{ constant('BASE_URL') }}assets/izitoast/js/iziToast.min.js"></script>
      <script src="{{ constant('BASE_URL') }}assets/js/aacc/base_url.js"></script>	
    {% endblock %}
